...
# git-lfs=2.9.2-1 was removed since it is not available.
sudo apt install build-essential cmake doxygen g++-9 gdb git python3-pip python3-venv libboost-dev libtinfo-dev libgtk-3-dev subversion tightvncserver \
